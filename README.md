...
UNITOV schema and parser collection for the NOMAD platform.
...
```sh
git clone https://github.com/fabianschoeppach/nomad-UNITOV-plugin.git
cd nomad-UNITOV-plugin
...
```sh
pip install dist/nomad-UNITOV-plugin-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Fabian Schöppach | [fabian.schoeppach@physik.hu-berlin.de](mailto:fabian.schoeppach@physik.hu-berlin.de)
